...
export interface ApiBlogCommentBlogComment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    author_user: Schema.Attribute.Relation<
      'manyToOne',
    ...
    replies: Schema.Attribute.Relation<
      ...
      'api::blog-comment.blog-comment'
    >;
    status: Schema.Attribute.Enumeration<['approved', 'pending', 'blocked']> &
...
export interface ApiBlogSeriesBlogSeries extends Struct.CollectionTypeSchema {
  collectionName: 'series';
  info: {
    displayName: 'Series';
    pluralName: 'series';
    singularName: 'blog-series';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPostVersionPostVersion extends Struct.CollectionTypeSchema {
  collectionName: 'post_versions';
  info: {
    description: 'Store snapshots of posts for version control';
    displayName: 'Post Version';
    pluralName: 'post-versions';
    singularName: 'post-version';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    liked_by_users: Schema.Attribute.Relation<
      'manyToMany',
      'plugin::users-permissions.user'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::blog-series.blog-series': ApiBlogSeriesBlogSeries;
      'api::category.category': ApiCategoryCategory;
      'api::contact.contact': ApiContactContact;
      'api::post-version.post-version': ApiPostVersionPostVersion;
